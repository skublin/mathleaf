...
{{< figure src="/images/blog_pipeline.svg" alt="Pipeline Image" class="svg-image-class" >}}

<!--- Image should be added like this:
![Image Description](/images/blog_pipeline%201.svg){: .svg-image-class}
and later edited (openai api?) to use shortcodes as above (!)
--->
